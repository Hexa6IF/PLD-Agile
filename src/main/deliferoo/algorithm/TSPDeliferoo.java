...
public class TSPDeliferoo {
	 ...
	 */	
	 private void branchAndBound(SpecialNode currentNode, ArrayList<SpecialNode> undiscovered, ArrayList<SpecialNode> discovered,
		...
		Iterator<SpecialNode> it = iterator(currentNode, undiscovered);
	        while (it.hasNext()){
	        	...
	        	branchAndBound(nextNode, undiscovered, discovered, discoveredCost 
	        		...
	        		+ nextNode.getDuration().intValue() 
	        		+ this.bound(currentNode, undiscovered, cost), cost, startTime, timeLimit);
