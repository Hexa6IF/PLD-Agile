...
/**
 * Class that implements the Dijkstra algorithm to compute the shortest path between each SpecialNodes
 * 
 * @author 
 *
 */
public class Dijkstra {
	...
	/**
	 * Method computing every BestPath for a list of deliveries
	 * 
	 * @param deliveries
	 * @param map
	 * @return A map that contains the BestPath (list of edges) between a node and an other node. 
	 * The key of the first Map is the id of the start node and the key of the second Map is the id of the end node.
	 */
	...
	/**
	 * Method computing every BestPath between one Node and each specialNodes 
	 * 
	 * @param startNode
	 * @param specialNodes 
	 * @param map
	 * @return A Map that contains the BestPath (list of edges) between the startNode and each other node. 
	 * The key is the id of the end node.
	 */
